...
class MSSA(nn.Module):
    def __init__(self, config):
        ...
        self.fusion.add_module('fusion_layer_1', nn.Linear(in_features=self.config.hidden_size*9, out_features=self.config.hidden_size*3))
...
#         # For reconstruction
        ...
        h = torch.stack((self.utt_private_t, self.utt_private_v, self.utt_private_a, self.utt_shared_t, self.utt_shared_v,  self.utt_shared_a
                         ,self.utt_shared_t2,self.utt_shared_v2,self.utt_shared_a2), dim=0)
    ...
    def reconstruct(self,):
        ...
        self.utt_t = (self.utt_private_t + self.utt_shared_t + self.utt_shared_t2)
        self.utt_v = (self.utt_private_v + self.utt_shared_v + self.utt_shared_v2)
        self.utt_a = (self.utt_private_a + self.utt_shared_a + self.utt_shared_a2)
    ...
    def shared_private(self, utterance_t, utterance_v, utterance_a):
        ...
        self.utt_shared_t2 = self.shared(utterance_t)        
        self.utt_shared_a = self.shared(utterance_a)
        
        self.utt_shared_v2 = self.shared(utterance_v)        
        self.utt_shared_a2 = self.shared(utterance_a)
